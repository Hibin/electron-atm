function Parser(){
  ...
  this.parse = function (message, length){
    ...
    switch(splitted[0][0]){
      ...
      case '6':
        return this.parseElectronicJournal(splitted);
      case '8':
  ...
  this.parseElectronicJournal = function(splitted){
    let parsed = {};

    parsed.message_class = 'Electronic Journal';
  ...
  this.parseDataCommand = function(splitted){
    ...
    case '1':
      ...
      case '3':
        parsed.message_identifier = 'Configuration Parameters';
        break;
      case 'A':
        parsed.message_identifier = 'Enhanced Configuration Parameters';
        break;
      case 'C':
        parsed.message_identifier = 'Date Time set';
        break;
      case 'E':
...
Parser.prototype.parseHostMessage = function(message){
  return this.parse(
    Buffer.from(message).toString('utf8').substring(2),
    this.getIncomingMessageLength(Buffer.from(message).toString('utf8'))
  );
};
